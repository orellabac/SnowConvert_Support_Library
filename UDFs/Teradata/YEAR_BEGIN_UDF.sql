...
-- RETURNS 2021-01-01
-- ======================================================================
CREATE OR REPLACE FUNCTION PUBLIC.FIRST_DAY_JANUARY_OF_ISO(INPUT TIMESTAMP_TZ) RETURNS DATE AS
$$
...
-- RETURNS 2021-01-04, 2022-01-03
-- ======================================================================
CREATE OR REPLACE FUNCTION PUBLIC.YEAR_BEGIN_ISO_UDF(INPUT DATE) RETURNS DATE AS
$$
     CASE 
     WHEN DAYOFWEEKISO(FIRST_DAY_JUANARY_OF_ISO(INPUT))>=5 THEN DATEADD(day,8-DAYOFWEEKISO(FIRST_DAY_JUANARY_OF_ISO(INPUT)),FIRST_DAY_JUANARY_OF_ISO(INPUT))
     WHEN DAYOFWEEKISO(FIRST_DAY_JUANARY_OF_ISO(INPUT))>=2 THEN DATEADD(day,1-DAYOFWEEKISO(FIRST_DAY_JUANARY_OF_ISO(INPUT)),FIRST_DAY_JUANARY_OF_ISO(INPUT))
...
-- RETURNS 2022-01-01, 2022-01-01
-- ======================================================================
CREATE OR REPLACE FUNCTION PUBLIC.YEAR_BEGIN_UDF(INPUT date) RETURNS DATE AS
$$
