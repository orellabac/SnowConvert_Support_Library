...
-- RETURNS 2021-12-31
-- ======================================================================
CREATE OR REPLACE FUNCTION PUBLIC.LAST_DAY_DECEMBER_OF_ISO(INPUT TIMESTAMP_TZ) RETURNS DATE AS
$$
...
-- RETURNS 2022-01-02, 2023-01-01
-- ======================================================================
CREATE OR REPLACE FUNCTION PUBLIC.YEAR_END_ISO_UDF(INPUT date) RETURNS DATE AS
$$
     CASE 
...
-- RETURNS 2022-12-31, 2022-12-31
-- ======================================================================
CREATE OR REPLACE FUNCTION PUBLIC.YEAR_END_UDF(INPUT date) RETURNS DATE AS
$$
     LAST_DAY(INPUT,'year')
$$;
