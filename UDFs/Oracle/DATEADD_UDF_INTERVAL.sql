...
-- =========================================================================================================
CREATE OR REPLACE FUNCTION DATEADD_UDF(D TIMESTAMP_TZ(9),INTERVAL VARCHAR) RETURNS TIMESTAMP_TZ(9)
...
CREATE OR REPLACE FUNCTION DATEADD_UDF(D DATE,INTERVAL VARCHAR) RETURNS DATE
LANGUAGE SQL AS
$$
