...
-- EQUIVALENT: Oracle TIMESTAMP - TIMESTAMP, DATE - TIMESTAMP, TIMESTAMP - DATE
-- NOTE: FOR OTHER CASES SUCH AS DATE - DATE, DATE - FLOAT ETC PLEASE REFER TO DATE_DIFF_UDF()
-- PARAMETERS:
...
--  2:
--    SELECT TIMESTAMP_DIFF_UDF('2022-02-14 14:31:00','2022-02-15'); -- SELECT TO_TIMESTAMP('2022-02-14 14:31:00','YYYY-MM-DD HH24:MI:SS') - TO_DATE('2022-02-15','YYYY-MM-DD') FROM DUAL;
--    RETURNS '-000000000 09:29:00.000000000'
