...
$$
   DECODE(INPUT_PART,
           ...
           'DAY TO HOUR',      TO_VARCHAR(TRUNC(DATEDIFF(SECONDS, DATE2, DATE1)/(86400))) || ' ' || PUBLIC.TIME_DIFFERENCE_UDF(LEAST(DATE1,DATE2), GREATEST(DATE1, DATE2), 'HOUR'),
           'DAY TO MINUTE',    TO_VARCHAR(TRUNC(DATEDIFF(SECONDS, DATE2, DATE1)/(86400))) || ' ' || PUBLIC.TIME_DIFFERENCE_UDF(LEAST(DATE1,DATE2), GREATEST(DATE1, DATE2), 'MINUTE'),
           'DAY TO SECOND',    TO_VARCHAR(TRUNC(DATEDIFF(SECONDS, DATE2, DATE1)/(86400))) || ' ' || PUBLIC.TIME_DIFFERENCE_UDF(LEAST(DATE1,DATE2), GREATEST(DATE1, DATE2), 'SECOND'),
           'HOUR',             TO_VARCHAR(DATEDIFF(HOUR, DATE2, DATE1)),
           'HOUR TO MINUTE',   TO_VARCHAR(DATEDIFF(HOUR, DATE2, DATE1)) || ':' || SPLIT_PART(PUBLIC.TIME_DIFFERENCE_UDF(LEAST(DATE1,DATE2), GREATEST(DATE1, DATE2), 'MINUTE'), ':', 2),
           'HOUR TO SECOND',   TO_VARCHAR(DATEDIFF(HOUR, DATE2, DATE1)) || ':' || SUBSTR(PUBLIC.TIME_DIFFERENCE_UDF(LEAST(DATE1,DATE2), GREATEST(DATE1, DATE2), 'SECOND'), -5),
           'MINUTE',           TO_VARCHAR(DATEDIFF(MINUTE, DATE2, DATE1)),
           'MINUTE TO SECOND', TO_VARCHAR( TRUNC(DATEDIFF(SECONDS, DATE2, DATE1)/60), 'FM9900') || ':' || SUBSTR(PUBLIC.TIME_DIFFERENCE_UDF(LEAST(DATE1,DATE2), GREATEST(DATE1, DATE2), 'SECOND'), -2),
